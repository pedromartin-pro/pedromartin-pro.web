<template>
  <div class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-9">
            <ProductImages
              ...
              :images="['/images/varillas2.jpg', '/images/varillas3.jpg', '/images/varillas4.jpg', '/images/varillas5.jpg', '/images/varillas6.jpg']"
            ></ProductImages>
          </div>
    ...
    <section class="module p-t-0">
      <ProductTabs
        :description="t('rod_pyro_extended')"
        :options="[{title:t('types'), value:t('rod_pyro_types')}, {title:t('sizes'), value:t('rod_pyro_sizes')}, {title:t('wood'), value:t('pine')}, {title:t('painted'), value:t('no')}]"
      ></ProductTabs>
    </section>
