  ...
  <div class="wrapper">
   ...
   ></ProductHeader>
    ...
    <section class="module">
      <div class="container">
        <div class="row">
          <div class="col-lg-9">
            <ProductImages
              mainImage="/images/persianas.jpg"
              :images="['/images/persianas2.jpg', '/images/persianas3.jpg']"
            ></ProductImages>
          </div>
    ...
    <section class="module p-t-0">
      <ProductTabs
        :description="t('plastic_stile_extended')"
        :options="[{title:t('types'), value:t('plastic_stile_types')}, {title:t('sizes'), value:t('plastic_stile_sizes')}, {title:t('wood'), value:t('pine')}, {title:t('painted'), value:t('no')}]"
      ></ProductTabs>
    </section>
